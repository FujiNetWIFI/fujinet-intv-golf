...
the donor's name/terminology, not just the symbols).  Almost none of
...
Target audience: you, six months from now, starting the ninth port.
...
| | Baseball (done) | NFL Football (done) | Auto Racing (done) | Armor Battle (done) | Utopia (done) | Frog Bog (done) | Boxing | NASL Soccer (done) | PGA Golf (done) |
|---|---|---|---|---|---|---|---|---|---|
...
| **tick rate** | **10 Hz (100 ms)** | **20 Hz (50 ms)** | **20 Hz (50 ms)** | **20 Hz (50 ms)** | **20 Hz (50 ms)** | **20 Hz (50 ms)** | **20 Hz (50 ms)** | **MEASURED 14.97 Hz (66.8 ms) — header implies 20 Hz; see §7.28** | **MEASURED 20.0 Hz (exactly 3.000 frames) — matches the header, no ISR-dance surprise** |
